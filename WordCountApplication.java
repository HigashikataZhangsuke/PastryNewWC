			 "FCiQkvwIRmjYUtN","RxmaWtfoAbiPjvT","OJNrehDEyMwcvWY","BOuVrZQJTdRkvYC","cVfDULyqharNXEe","CjMevBgondWLQZK","GgUdoIvjPWpYqXQ","qdnHRGTDrhsSFfV","qoAWpwJsUMTvblV","pnxbiqYrURGBfyW","lCcngUjWDJMGLzh",
			 "MAPSVsvqaxGIuhi","DZCiFXKglLBVNrG","aLOlZFIuMGcVUmn","wcsPBqtSFlNKXVJ","jIaCikhmxUgorMG","HpieODJzmlsMoVy","VxKFOjyMQTJzpGu","ZKpQxcBafolVitb","DLhiNFvsUMBwoRP","jyEhIotUMXqAmGV","jWqkndsJTbzhPgU",
			 "BojcRhlIzEXntWA","vjWAHVqzPQIfOTY","WhjtIUyavVQdFOM","bsyJSmEpPWnLglC","VhdbiLQUXGYnFKa","ikbJBUryqWgxHzt","qISMXdHYtjrTcKF","QRgdqENMAciBpoV","fFSHlcnTPOZyJjx","OzJNevUlWMIyHLA"};
	 ...
	 public WordCountApplication(Node node,int topicnumin) {
		  ...
		  for (int i=0;i<topicnum;i++) {
			 ...
			 // this.loggertpname(tpvec.elementAt(i).toString());
		  }
	 }
	 ...
	 public void startPublishTaskforleaf(Topic tp) {
    	  ...
    	  if (content instanceof MsgOfRequestUpdate){
    		  ...
    		  if (this.whichwindow.get(whichtp)!=1) {
    			  if (this.childlist.get(whichtp)!=null) {
    				  ...
    				  this.childlist.get(whichtp).replaceAll((key,value)->0);
    			  }
    			 // }	  
  	  ...
  	  public void deliver(Id id, Message message) {
  		  if(message instanceof BottomNodesMsg) {  		    	
  		   //You received the message, then just need to merge it with your data and upload it
  		    	...
  		    	/**
  		  	if (this.childlist.get(thistp)!=null) {
  				if (this.childlist.get(thistp).get(from)!=null) {
  			        this.childlist.get(thistp).put(from, this.childlist.get(thistp).get(from)+1);
  				}
  				else {
  					//have this tp. But do not have Id record.
  					// LinkedHashMap<Id,Integer> Precnt = this.childlist.get(thistp);
  			    	// Precnt.put(from, 0);
  					 //Merge here.
  			    	 //this.childlist.put(thistp,Precnt);
  					this.childlist.get(thistp).put(from, 0);//just add the new one here
  				}
  			}
  		  	
  			else {
  				LinkedHashMap<Id,Integer> Precnt = new LinkedHashMap<Id,Integer>();
  			    	 Precnt.put(from, 0);
  				 this.childlist.put(thistp,Precnt);
  			}**/
  		    	try {
  		    	//this.loggertpname("======================================================");
  		    	//this.loggertpname(thistp.toString());
  		    	this.childlist.get(thistp).put(from, this.childlist.get(thistp).get(from)+1);
  		    	}
  		    	catch (Exception e) {
  		    		this.loggerexp("Exeception happened on node "+this.endpoint.getId()+" with topic "+ thistp.toString());
  		    	}
	  ...
	  public void subscribeFailed(Topic topic) {
		 ...
		 public void loggerexp(String str) {
			 FileWriter fw = null;
			 try {
				 File f = new File("/home/johnny/Testlog/Yinzheexp"+this.endpoint.getId()+".txt");
			     fw = new FileWriter(f,true);
			 // }
			 }catch(IOException e) {
				 e.printStackTrace();
		 ...
		 public void loggertpname(String str) {
			 FileWriter fw = null;
			 try {
				 File f = new File("/home/johnny/Testlog/Yinzhetpname"+this.endpoint.getId()+".txt");
			     fw = new FileWriter(f,true);
			 // }
			 }catch(IOException e) {
				 e.printStackTrace();
